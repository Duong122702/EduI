...
import { AddExam } from '@/features/examroom/components/AddExam';
...
export const ExamRoom = () => {
  ...
  return (
    <>
      <div
        className={`${isAddExamOpen ? 'hidden' : 'block'} w-full space-y-6 p-6`}
      >
        ...
        <div>
          <ExamRoomTable
            ...
            isPending={isPending}
            setIsAddExamOpen={setIsAddExamOpen}
          />
        </div>
      </div>
      <AddExam isOpen={isAddExamOpen} setIsOpen={setIsAddExamOpen} />
    </>
  );
};
